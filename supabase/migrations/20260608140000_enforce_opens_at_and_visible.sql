-- Enforce opens_at and visible=false in create_registration RPC
...
BEGIN
  ...
  SELECT max_slots, age_rule_mode, age_min, opens_at, visible
    INTO v_max, v_age_mode, v_age_min, v_opens_at, v_visible
